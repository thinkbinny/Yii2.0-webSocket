...
abstract class Command extends Controller
{
     ...
     * @return array
     */
    protected function triggerMessage($server,$fd, $data)
    {
        ...
        $result = call_user_func([$class, 'execute'], $server,$fd, json_decode($data));
    ...
    protected function getClass($className)
    {
        ...
        if (!($class instanceof \yii\websocket\ChannelInterface)) {
